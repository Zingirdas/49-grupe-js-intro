...
//     // n -> string -> split -> array -> for -> skaitmens zodis

//     const dictionary = ['zero', 'one', 'two', 'tree', 'four', 'five', 'six', 'seven', 'eight', 'nine'];
//     const text = '' + n;        // is skaiciaus i zodi konvertuojam
//     const numbers = text.split('');
//     const result = [];


//     for (const number of numbers) {
//         const index = +number;   // is zodzio i skaiciu konvertacija
